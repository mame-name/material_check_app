...
def create_pivot(df_req, df_inv, df_ord):
    ...
    # 4. 発注リスト（納品数）の集計 ★ここで明日以降のみに絞り込む
    ...
    for (code, name), req_values in pivot_req.iterrows():
        ...
        for date_label in date_labels:
            ...
            # pivot_ordは既に明日以降に絞られているため、今日の分は自動的に0になる
